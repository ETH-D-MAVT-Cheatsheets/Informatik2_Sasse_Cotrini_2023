...
def height(a):
    ...
    {\centering\underline{\textbf{Sift Up}} \par}
        ...
        \lstinputlisting{src/4_data_structure/code/heap_sift_up.py}
    ...
    {\centering\underline{\textbf{Sift Down}} \par}
        ...
        \lstinputlisting{src/4_data_structure/code/heap_sift_down.py}

    {\centering\underline{\textbf{Insert}} \par}
        \lstinputlisting{src/4_data_structure/code/heap_insert.py}
    ...
    {\centering\underline{\textbf{Remove Max Value}} \par}
        ...
        \lstinputlisting{src/4_data_structure/code/heap_remove_max.py}
    ...
    {\centering\underline{\textbf{Heap creation / Heapify}} \par}
        ...
        \lstinputlisting{src/4_data_structure/code/heap_heapify.py}

    {\centering\underline{\textbf{Sorting a heap}} \par}
        If "a" is a heap, one can efficiently sort the array:
        \lstinputlisting{src/4_data_structure/code/heap_sort.py}
